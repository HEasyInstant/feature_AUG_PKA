...
<title>Planelt Pol application</title>
...
<div align="center">
   ...
   <!--  <a href="/new">View PolClaims List</a> -->
    ...
    <tr><td>Protocol:<input type="text" name="txtprotocol"/></td>
     <td>Chassis_CODE:<input type="text" name="txtchasiscode"/></td>
    <td> Search:<input type="submit" name="subtn"  value="Click"/></td></tr>
